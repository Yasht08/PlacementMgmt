...
public class Insert extends JFrame implements ActionListener 
{
	...
	private static final String DB_URL = "jdbc:mysql://localhost:3306/Placement";
	...
	public void insertIntoDatabase(String name, String usn, String sem, String branch, String cgpa, String nob, String company, String ctc, String comments) {
        try {
            String query = "INSERT INTO place (name, usn, sem, branch, cgpa, nob, company, ctc, comments) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                preparedStatement.setString(5, cgpa);
                preparedStatement.setString(6, nob);
                preparedStatement.setString(7, company);
                preparedStatement.setString(8, ctc);
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        if(ae.getSource()==insert)
        {
			...
			{
				if (!validateInput()) {
					insertIntoDatabase(name, usn1, sem, branch, cgpa, nob, company, ctc, comments);
					return;
				}
	...
	public boolean validateInput() {
		...
		String usn1 = usnT.getText().trim();
		String cgpa = cgpaT.getText().trim();
		String nob = nobT.getText().trim();
		String comments = commentsT.getText().trim();
		...
		// Add more validation rules as needed, e.g., for numerical values, length, etc.
