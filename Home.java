...
public class Home extends JFrame implements ActionListener
{
	...
	Home()
	{
		super("Placement Management Portal");
		...
		while (heading.getPreferredSize().width > 400) {
			fontSize--; // Decrease font size
			fonth = new Font("Verdana", Font.BOLD, fontSize);
			heading.setFont(fonth);
		}
		...
		con.setLayout(null);
		ImageIcon img = new ImageIcon("C:\\Users\\yasht\\Downloads\\Java\\Placement_Management_System-master\\Placement_Management_System-master\\placement.png");
        Image originalImage = img.getImage();
        Image scaledImage = originalImage.getScaledInstance(1200, 850, Image.SCALE_SMOOTH);
        ImageIcon scaledImg = new ImageIcon(scaledImage);
        JLabel background = new JLabel(scaledImg);
